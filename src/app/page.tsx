...
const apps = [
  {
    ...
    name: "FocusFlow",
    icon: "🎯",
    description: "A beautiful Pomodoro timer with ambient soundscapes and session tracking. Stay focused and boost productivity.",
    category: "productivity",
    color: "purple",
    downloadUrl: "#",
    downloadType: "mac-app-store",
  },
  {
    id: 2,
    name: "ClipMaster",
    icon: "📋",
    description: "Advanced clipboard manager with history, snippets, and quick paste hotkeys. Never lose copied content again.",
    category: "utilities",
    color: "pink",
    downloadUrl: "#",
    downloadType: "direct",
  },
  {
    ...
    name: "DevToolkit",
    icon: "🛠️",
    description: "All-in-one developer utility suite featuring JSON formatter, base64 encoder, JWT decoder, and more.",
    category: "developer",
    color: "cyan",
    downloadUrl: "#",
    downloadType: "mac-app-store",
  },
  {
    ...
    name: "WindowSnap",
    icon: "🪟",
    description: "Effortless window management with keyboard shortcuts. Snap windows to grid, create custom layouts.",
    category: "utilities",
    color: "emerald",
    downloadUrl: "#",
    downloadType: "direct",
  },
  {
    ...
    name: "NoteSync",
    icon: "📝",
    description: "Markdown note-taking app with iCloud sync. Beautiful writing experience with live preview.",
    category: "productivity",
    color: "amber",
    downloadUrl: "#",
    downloadType: "mac-app-store",
  },
  {
    ...
    name: "ColorPal",
    icon: "🎨",
    description: "Color picker and palette generator with eyedropper, contrast checker, and export to multiple formats.",
    category: "developer",
    color: "violet",
    downloadUrl: "#",
    downloadType: "direct",
